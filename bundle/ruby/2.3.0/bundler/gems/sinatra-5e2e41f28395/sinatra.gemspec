...
Gem::Specification.new do |s|
  ...
  s.files = [".yardopts".freeze, "AUTHORS.md".freeze, "CHANGELOG.md".freeze, "CONTRIBUTING.md".freeze, "Gemfile".freeze, "LICENSE".freeze, "MAINTENANCE.md".freeze, "README.de.md".freeze, "README.es.md".freeze, "README.fr.md".freeze, "README.hu.md".freeze, "README.ja.md".freeze, "README.ko.md".freeze, "README.malayalam.md".freeze, "README.md".freeze, "README.pt-br.md".freeze, "README.pt-pt.md".freeze, "README.ru.md".freeze, "README.zh.md".freeze, "Rakefile".freeze, "SECURITY.md".freeze, "VERSION".freeze, "examples/chat.rb".freeze, "examples/simple.rb".freeze, "examples/stream.ru".freeze, "lib/sinatra".freeze, "lib/sinatra.rb".freeze, "lib/sinatra/base.rb".freeze, "lib/sinatra/images".freeze, "lib/sinatra/images/404.png".freeze, "lib/sinatra/images/500.png".freeze, "lib/sinatra/indifferent_hash.rb".freeze, "lib/sinatra/main.rb".freeze, "lib/sinatra/show_exceptions.rb".freeze, "lib/sinatra/version.rb".freeze, "sinatra.gemspec".freeze]
