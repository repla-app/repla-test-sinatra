...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE".freeze, "README.md".freeze, "Rakefile".freeze, "ideas.md".freeze, "lib/sinatra/capture.rb".freeze, "lib/sinatra/config_file.rb".freeze, "lib/sinatra/content_for.rb".freeze, "lib/sinatra/contrib.rb".freeze, "lib/sinatra/contrib/all.rb".freeze, "lib/sinatra/contrib/setup.rb".freeze, "lib/sinatra/contrib/version.rb".freeze, "lib/sinatra/cookies.rb".freeze, "lib/sinatra/custom_logger.rb".freeze, "lib/sinatra/decompile.rb".freeze, "lib/sinatra/engine_tracking.rb".freeze, "lib/sinatra/extension.rb".freeze, "lib/sinatra/json.rb".freeze, "lib/sinatra/link_header.rb".freeze, "lib/sinatra/multi_route.rb".freeze, "lib/sinatra/namespace.rb".freeze, "lib/sinatra/reloader.rb".freeze, "lib/sinatra/required_params.rb".freeze, "lib/sinatra/respond_with.rb".freeze, "lib/sinatra/runner.rb".freeze, "lib/sinatra/streaming.rb".freeze, "lib/sinatra/test_helpers.rb".freeze, "lib/sinatra/webdav.rb".freeze, "sinatra-contrib.gemspec".freeze]
